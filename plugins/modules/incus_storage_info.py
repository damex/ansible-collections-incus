...
"""Ensure Incus storage pool info is gathered."""
...
short_description: Ensure Incus storage pool information is gathered
...
def main() -> None:
    """Run module."""
    incus_ensure_global_info('storage-pools', 'storage_pools')
